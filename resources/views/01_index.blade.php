...
<body>
    ...
    <div class="container-fluid px-0 py-5 my-5">
        ...
        <div class="owl-carousel service-carousel">
            <div class="service-item position-relative">
                <img class="img-fluid" src="1_assets/img/service-1.jpg" alt="">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="1_assets/img/service-2.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="1_assets/img/service-3.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="1_assets/img/service-4.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="1_assets/img/service-5.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="service-item position-relative">
                <img class="img-fluid" src="1_assets/img/service-6.jpg" alt="">
                <div class="service-text text-center">
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="1_assets/img/opening.jpg" style="object-fit: cover;">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="1_assets/img/pricing.jpg" style="object-fit: cover;">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="1_assets/img/fakehuman001.jpg" alt="">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="1_assets/img/fakehuman015.jpg" alt="">
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="1_assets/img/fakehuman018.jpg" alt="">
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team position-relative overflow-hidden mb-5">
                        <img class="img-fluid" src="1_assets/img/fakehuman010.jpg" alt="">
                        <div class="position-relative text-center">
                            <div class="team-text bg-primary text-white">
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6 pb-5 pb-lg-0">
                    <img class="img-fluid w-100" src="1_assets/img/testimonial.jpg" alt="">
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="position-relative">
                            ...
                            <div class="d-flex align-items-center mb-3">
                                <img class="img-fluid rounded-circle" src="1_assets/img/fakehuman012.jpg" style="width: 60px; height: 60px;" alt="">
                                <div class="ml-3">
                        ...
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                <img class="img-fluid rounded-circle" src="1_assets/img/fakehuman008.jpg" style="width: 60px; height: 60px;" alt="">
                                <div class="ml-3">
                        ...
                        <div class="position-relative">
                            <i class="fa fa-3x fa-quote-right text-primary position-absolute" style="top: -6px; right: 0;"></i>
                            <div class="d-flex align-items-center mb-3">
                                <img class="img-fluid rounded-circle" src="1_assets/img/fakehuman004.jpg" style="width: 60px; height: 60px;" alt="">
                                <div class="ml-3">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 pt-5 pb-lg-5">
                <div class="contact-form bg-light p-4 p-lg-5 my-lg-5">
                    ...
                    <div id="success"></div>
                    <form   action="https://getform.io/f/5356c43e-9325-465c-9d25-d5a75433771f" method="POST">
                        <div class="form-row">
...
<!-- Contact End -->
    ...
    <script>
      ...
      var markers = [
        ...
        { position: [{{$l->lat}}, {{$l->lng}}], title: '{{$l->location}}' },
        @endforeach
      ];

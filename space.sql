...
(1, 1, 2, 'Magandang araw po! Gusto ko po sanang magtanong tungkol sa inyong therapy services. Ano po ang inyong mga serbisyo?', '2023-03-01', '10:30:00'),
(2, 1, 3, 'Mayroon po ba kayong available na slot para sa isang therapy session? Magkano po ang bayad at gaano katagal ito?', '2023-03-02', '11:30:00'),
(3, 1, 4, 'Maari po bang magtanong kung anong uri ng therapy ang nararapat sa akin? Mayroon po ba kayong free consultation?', '2023-03-03', '12:30:00'),
(4, 1, 5, 'Nais ko po sanang malaman kung ano ang inyong kwalipikasyon bilang isang therapist at kung mayroon kayong mga rekomendasyon mula sa mga naging kliyente ninyo.', '2023-03-04', '13:30:00'),
(5, 1, 6, 'Salamat po sa inyong mga serbisyo. Mayroon po ba kayong discounts o promos sa inyong mga regular na kliyente?', '2023-03-05', '14:30:00'),
(6, 2, 1, 'Kumusta po! Ako po ay isang lisensyadong propesyunal sa larangan ng therapy at handa po akong magbigay ng serbisyo sa inyo.', '2023-03-06', '15:30:00'),
(7, 3, 1, 'Kung kayo po ay naghahanap ng solusyon sa mga personal o pamilya ninyong problema, nandito po ako para tulungan kayo.', '2023-03-07', '16:30:00'),
(8, 4, 1, 'Mayroon po ba kayong nararamdaman na hindi maipaliwanag? Ako po ay handang makinig sa inyong kwento at magbigay ng suporta sa inyo.', '2023-03-08', '08:00:00'),
(9, 5, 1, 'Kung kayo po ay nakakaranas ng depression, anxiety, o iba pang mental health issues, ako po ay nandito para tulungan kayo.', '2023-03-09', '09:00:00'),
(10, 6, 1, 'Nag-aalala po ba kayo tungkol sa mga relationship problems ninyo? Ako po ay handang makipagtulungan sa inyo upang masolusyunan ito.', '2023-03-01', '10:00:00'),
(11, 2, 1, 'Sa pamamagitan ng therapy, maaari po nating matuklasan ang mga bagay na nagiging hadlang sa inyong pagkamit ng mga pangarap at mga layunin sa buhay.', '2023-03-02', '11:00:00'),
(12, 3, 1, 'Huwag po kayong mag-alala tungkol sa mga judgmental na pananaw sa therapy. Ako po ay handang makinig sa inyong mga kwento nang walang paghuhusga.', '2023-03-03', '12:00:00'),
(13, 4, 1, 'Ako po ay mayroong mga specialized na teknik at approach sa therapy upang masigurado na ang inyong mga kailangan ay nasusunod.', '2023-03-04', '13:00:00'),
(14, 5, 1, 'Maaari po akong magbigay ng tulong sa inyong pagtitiwala sa sarili, pagkakaroon ng mas malalim na relasyon sa mga mahal sa buhay, at marami pa.', '2023-03-05', '14:00:00'),
(15, 6, 1, 'Nagbibigay po ako ng malasakit, pagsuporta, at pag-intindi sa bawat kliyente.', '2023-03-06', '15:00:00'),
(16, 2, 1, 'Kung kayo po ay naghahanap ng makakausap tungkol sa inyong mga problema, ako po ay handa na makinig sa inyo.', '2023-03-07', '13:30:00'),
(17, 3, 1, 'Napakahalaga po ng kalidad ng kalusugan sa isip at damdamin. Handa po akong magtulungan sa inyo upang mapanatili ang inyong kalusugang ito.', '2023-03-08', '14:30:00'),
(18, 4, 1, 'Sa pamamagitan ng therapy, maaari po nating matutunan kung paano harapin ang stress at mga pagsubok sa buhay.', '2023-03-09', '15:30:00'),
(19, 5, 1, 'Kung kayo po ay may mga pagkabahala o takot sa mga bagay-bagay sa buhay, ako po ay handang magbigay ng tulong upang malampasan ito.', '2023-03-01', '16:30:00'),
(20, 6, 1, 'Maaari po tayong magtrabaho upang mapabuti ang inyong pakikitungo sa mga taong mahalaga sa inyo.', '2023-03-02', '08:00:00'),
(21, 2, 1, 'Ang therapy ay hindi lamang para sa mga may malalang problema. Maaari itong magbigay ng suporta at paglinaw sa kahit anong sitwasyon sa buhay.', '2023-03-03', '09:00:00'),
(22, 3, 1, 'Kung kayo po ay may mga katanungan tungkol sa therapy, huwag po kayong mag-alinlangan na magtanong. Handa po akong magbigay ng impormasyon.', '2023-03-04', '15:30:00'),
(23, 4, 1, 'Sa pamamagitan ng therapy, maaari po tayong magtrabaho upang maipaglaban ang inyong mga adhikain at pangarap sa buhay.', '2023-03-05', '16:30:00'),
(24, 5, 1, 'Ako po ay isang propesyunal sa larangan ng therapy at nais kong magbigay ng tulong sa inyo. Huwag po kayong mag-atubiling lumapit sa akin.', '2023-03-06', '17:30:00');
...
(105, 'katarinagarcia@gmail.com', '$2y$10$86Kl.fDiBisBN8EfBDWoYOb3YSgIXPE0xQMl5f5gs/Zz7CvRJtTum', 'customer');
